...
<head>
    ...
    <title>RH, Licitações, Arrecadação e Outras Áreas - SENAI</title>
    <link rel="stylesheet" href="../css/opcoes/rh_outras.css">
...
<body class="transition-colors duration-300">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="fixed inset-y-0 left-0 w-64 bg-senai-red text-white transform transition-transform duration-300 ease-in-out z-20" id="sidebar">
            ...
            <nav class="mt-5">
                ...
                <a href="../whatsapp.php" class="flex items-center p-4 hover:bg-white/20 transition-colors rounded-r-lg">
                    <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.458 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7z" />
                    </svg>
                    Conectar WhatsApp
                </a>
        ...
        <div class="flex-1 flex flex-col overflow-hidden main-content lg:ml-64">
            ...
            <header class="fixed top-0 left-0 right-0 bg-white dark:bg-gray-100 shadow-custom p-4 flex justify-between items-center z-10 header">
                <button class="lg:hidden" onclick="toggleSidebar()">
                    <svg class="w-6 h-6 text-senai-gray" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-6 mt-16">
                <h1 class="text-2xl sm:text-3xl font-bold text-senai-gray mb-6">RH, Licitações, Arrecadação e Outras Áreas</h1>

                <!-- Seção de Pesquisa -->
                <div class="search-section">
                    <form id="searchForm" method="GET" action="rh_outras.php">
                ...
                <div class="filters mb-4">
                    <form id="filterForm" method="GET" action="rh_outras.php">
                ...
                <div class="atendimentos-list" id="atendimentosList">
                    <?php if (count($atendimentos) > 0): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p class="no-data">Nenhum atendimento registrado para RH, Licitações, Arrecadação e Outras Áreas.</p>
                    <?php endif; ?>
                </div>
    ...
    <script src="../script/opcoes/rh_outras.js"></script>
</body>
