...
<head>
    ...
    <title>Documentação e Certificados - SENAI</title>
    <link rel="stylesheet" href="../css/opcoes/documentacao.css">
...
<body class="transition-colors duration-300">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden main-content lg:ml-64">
            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-6 mt-16">
                <h1 class="text-2xl sm:text-3xl font-bold text-senai-gray mb-6">Documentação e Certificados</h1>

                <!-- Seção de Pesquisa -->
                <div class="search-section">
                    <form id="searchForm" method="GET" action="documentacao.php">
                ...
                <div class="filters mb-4">
                    <form id="filterForm" method="GET" action="documentacao.php">
                ...
                <div class="atendimentos-list" id="atendimentosList">
                    <?php if (count($atendimentos) > 0): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p class="no-data">Nenhum atendimento registrado para Documentação e Certificados.</p>
                    <?php endif; ?>
                </div>
    ...
    <script src="../script/opcoes/documentacao.js"></script>
</body>
</html>